...
<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
  ...
  <el-form-item>
    <el-button type="primary" @click.native.prevent="handleSubmit" :disabled="submitStatus">立即创建</el-button>
    <el-button @click.native.prevent="handleReset">重置</el-button>
    <el-button @click.native.prevent="handlePost">MockUser</el-button>
  </el-form-item>
</el-form>
  </div>
</template>
